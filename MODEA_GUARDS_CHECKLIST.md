...
| Privacy notices (bilingual, accurate) | Pass | `docs/privacy-notice/operator-mode-a.md` now contains UTF-8 Mandarin copy aligned with the enforced architecture. |
| Important-Data checklist | Pass | `docs/important-data-checklist.md` documents mapping DB, KMS keys, Ed25519 pubkey, and client-event hashing with owners + verification steps. |
