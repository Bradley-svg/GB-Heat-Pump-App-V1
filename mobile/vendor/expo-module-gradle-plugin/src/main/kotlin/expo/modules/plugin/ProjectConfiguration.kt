 ...
 */
internal fun Project.applyPublishing(@Suppress("UNUSED_PARAMETER") expoModulesExtension: ExpoModuleExtension) {
  // Publishing functionality is disabled for the GreenBro app build.
}
